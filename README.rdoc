...
This is a ruby library for interacting with the bitcoin protocol/network along with Dogecoin support.

== Dogecoin

To interact with the Dogecoin protocol or network enter the line.

 Bitcoin.network =:dogecoin

You now use every bitcoin function now for dogecoin.
Generate a dogecoin key
